...
----
  ...
  dotnet add UserProfileDemo.Repositories.csproj Couchbase.Lite
----

*Note:* You can also install the package directly within Visual Studio using the link:https://docs.microsoft.com/en-us/nuget/tools/package-manager-ui[package manager].
...
----
+
* Build the solution using Visual Studio for Window or Mac.
...
In order to use Couchbase Lite within a Xamarin app the library will need to be activated for each platform. 
...
[source,c#]
----
include::./src/UserProfileDemo.iOS/AppDelegate.cs[tags=activate]
----
...
[source,c#]
----
include::./src/UserProfileDemo.Android/MainActivity.cs[tags=activate]
----
...
[source,c#]
----
include::./src/UserProfileDemo.UWP/MainPage.xaml.cs[tags=activate] 
----
