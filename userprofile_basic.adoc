...
----
+
* Build the solution using your preferred IDE (e.g. Visual Studio for Windows or Mac).
...
Before diving into the code for the apps, it is important to point out the Couchbase Lite dependencies within the solution. The link:https://www.nuget.org/packages/Couchbase.Lite/[Couchbase.Lite Nuget package] is included as a reference within three projects of this solution:
